...
% Last Modified by GUIDE v2.5 20-Feb-2018 09:51:46
...
handles.NB1 =  str2double(get(hObject,'String'));
guidata(hObject, handles);
...
handles.NB2 =  str2double(get(hObject,'String'));
guidata(hObject, handles);
...
handles.NB3 =  str2double(get(hObject,'String'));
guidata(hObject, handles);
